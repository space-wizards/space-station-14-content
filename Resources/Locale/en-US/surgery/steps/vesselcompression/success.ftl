...
surgery-step-vesselcompression-success-no-zone-popup = You compress vessels in {PROPER($part) ->
  [false] the
  *[bucket] {""}
} {$part}
...
surgery-step-vesselcompression-begin-no-zone-outsider-popup = {$user} compresses vessels in {PROPER($part) ->
  [false] the
  *[bucket] {""}
} {$part}
